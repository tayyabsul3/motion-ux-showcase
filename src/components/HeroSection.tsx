    ...
    <section id="home" className="relative min-h-screen flex items-center pt-16">
      ...
      <div className="section-container grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-md">
          ...
          <motion.div variants={itemVariants} className="flex gap-4">
            ...
            <a href="mailto:email@example.com" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors">
              <Mail size={24} />
        ...
        >
          <div className="relative">
            ...
            <img 
              src="https://images.unsplash.com/photo-1580927752452-89d86da3fa0a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1350&q=80" 
              alt="John Doe"
